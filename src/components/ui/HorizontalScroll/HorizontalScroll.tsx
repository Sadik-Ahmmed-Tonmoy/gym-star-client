  ...
  useEffect(() => {
    ...
    if (containerRef.current) {
      const controls = animate(
        ...
        {
          transform: ["none", `translateX(-${sections.length - 1}00vw)`],
        },
        { easing: spring() }
      );
      ...
      <main>
        <article>
          ...
          <section className="h-[500vh] relative">
            <div className="sticky top-0 no-horizontal-scrollbar overflow-auto">
              <div ref={containerRef} className="flex w-[500vw]">
                <div className="scroll-section h-screen w-screen bg-red-400 flex flex-col justify-center overflow-hidden items-center">
                  <h2 className="text-[20vw] font-semibold relative bottom-5 inline-block text-black">PASSION</h2>
                  <Image
                ...
                <div className="scroll-section h-screen w-screen bg-blue-400 flex flex-col justify-center overflow-hidden items-center">
                  <h2 className="text-[20vw] font-semibold relative bottom-5 inline-block text-black">WORK</h2>
                  <Image
                    src="https://res.cloudinary.com/dzl9yxixg/image/upload/v1713532202/ui-layout/team_gsu8ej.png"
                    className="2xl:w-[550px] w-[380px] absolute bottom-0"
                    width={500}
                ...
                <div className="scroll-section h-screen w-screen bg-orange-400 flex flex-col justify-center overflow-hidden items-center">
                  <h2 className="text-[20vw] font-semibold relative bottom-5 inline-block text-black">MOTIVATION</h2>
                  <Image
                    src="https://res.cloudinary.com/dzl9yxixg/image/upload/v1713532202/ui-layout/team_gsu8ej.png"
                    className="2xl:w-[550px] w-[380px] absolute bottom-0"
                    width={500}
                ...
                <div className="scroll-section h-screen w-screen bg-yellow-400 flex flex-col justify-center overflow-hidden items-center">
                  <h2 className="text-[20vw] font-semibold relative bottom-5 inline-block text-black">INSPIRATION</h2>
                  <Image
                    src="https://res.cloudinary.com/dzl9yxixg/image/upload/v1713532202/ui-layout/team_gsu8ej.png"
                    className="2xl:w-[550px] w-[380px] absolute bottom-0"
                    width={500}
                ...
                <div className="scroll-section h-screen w-screen bg-green-400 flex flex-col justify-center overflow-hidden items-center">
                  <h2 className="text-[20vw] font-semibold relative bottom-5 inline-block text-black">BELIEVE</h2>
                  <Image
                    src="https://res.cloudinary.com/dzl9yxixg/image/upload/v1713532202/ui-layout/team_gsu8ej.png"
                    className="2xl:w-[550px] w-[380px] absolute bottom-0"
                    width={500}
